...
import { resolveComponent, mergeProps, withCtx, createVNode, createTextVNode, defineComponent, ref, toDisplayString, createBlock, createCommentVNode, openBlock, useSSRContext } from 'vue';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_v_card, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_card_title, { class: "d-flex align-center justify-space-between flex-wrap" }, {
            ...
            return [
              createVNode(_component_v_card_title, { class: "d-flex align-center justify-space-between flex-wrap" }, {
                default: withCtx(() => [
                  createVNode("span", { class: "text-h5" }, "WebSocket BPM (minimal)"),
                  createVNode("div", {
                    class: "text-medium-emphasis",
  ...
  _push(ssrRenderComponent(_component_v_card, mergeProps({
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_v_card_text, { class: "" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        return [
          ...
          createVNode(_component_v_card_text, { class: "" }, {
            default: withCtx(() => [
              createVNode(_component_NuxtLink, {
                href: "http://www.umy-ma.sk",
                target: "_blank",
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/trainings.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const trainings = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { trainings as default };
//# sourceMappingURL=trainings-BCVXPLdj.mjs.map
