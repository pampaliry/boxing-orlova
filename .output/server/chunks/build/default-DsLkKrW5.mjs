import { defineComponent, ref, withCtx, createVNode, createTextVNode, toDisplayString, createBlock, openBlock, Fragment, renderList, computed, toRef, watchEffect, shallowRef, mergeProps, normalizeStyle, normalizeClass, createElementVNode, watch, nextTick, readonly, Transition, withDirectives, onScopeDispose, toRaw, provide, inject, toValue, vShow, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderAttrs } from 'vue/server-renderer';
import { ai as VApp, g as genericComponent, _ as _export_sfc, aj as __nuxt_component_1, p as propsFactory, h as useProxiedModel, z as useToggleScope, a8 as useLayoutItem, o as useRender, t as useRtl, i as provideTheme, Z as useDisplay, F as provideDefaults, ac as deprecate, ag as useLayout, G as useResizeObserver, v as convertToUnit, a9 as makeLayoutItemProps, D as clamp, C as omit, k as makeComponentProps, m as makeThemeProps, Y as makeDisplayProps, y as getCurrentInstance, E as EventProp, I as IconValue, ad as focusChild, aa as consoleError, ab as defineComponent$1, ah as defer, ae as isPrimitive, af as getPropertyFromItem, x as wrapInArray } from './server.mjs';
import { j as createSimpleFunctional, z as useBorder, l as useBackgroundColor, c as useElevation, f as useRounded, P as useRouter, Q as toPhysical, O as VImg, i as VDefaultsProvider, a as useDensity, b as useDimension, R as Ripple, C as useLink, u as useVariant, h as genOverlays, D as VAvatar, V as VIcon, S as VExpandTransition, o as makeTagProps, p as makeRoundedProps, s as makeElevationProps, H as makeBorderProps, n as makeVariantProps, t as makeDimensionProps, v as makeDensityProps, F as makeRouterProps, g as useTextColor, M as MaybeTransition } from './VAvatar-BKJVjbAt.mjs';
import { V as VContainer, a as VRow, b as VCol, c as VBtn, m as makeVBtnProps } from './VRow-CL5W32WL.mjs';
import 'node:http';
import 'node:https';
import 'node:zlib';
import 'node:stream';
