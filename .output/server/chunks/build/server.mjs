...
const mr = Symbol.toStringTag, wi = n$1((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n$1((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Ks = n$1((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Js = n$1((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a } = await import('./multipart-parser-CM5-_cud.mjs');
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BV3_ZBsJ.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-DG0zTbT9.mjs')
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import('./projects-RmrluQW_.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-B9ts_NH4.mjs').then((r2) => r2["default"] || r2.default || r2));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BGxnST3t.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-fZETfGZU.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-B_VTKCLM.mjs'));
